...
public class SeatUtilizationCourse {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "enrollment and capacity with hall coursename in different semesters");
		job.setJarByClass((Class) SeatUtilizationCourse.class);
		...
		Job job2 = new Job(conf2, "seat utilization wrt different courses in last 3 years");
		job2.setJarByClass((Class) SeatUtilizationCourse.class);
	...
	public static class Mapper1 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws InterruptedException, IOException {
			...
			StringBuilder semesterHallCourseIdNameKey = new StringBuilder();
			...
			try {
				...
				semesterHallCourseIdNameKey.append(season + "_" + year + "_" + hallName + "_" + capacity + "_"
						+ enrollMent + "_" + courseId + "_" + courseName);
				word.set(semesterHallCourseIdNameKey.toString());
	...
	public static class Mapper2 extends Mapper<Object, Text, Text, Text> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			try {
				...
				StringBuilder YearKey = new StringBuilder();
				StringBuilder capEnrollValue = new StringBuilder();
				YearKey.append(year + " " + courseId + " " + courseName);
				word.set(YearKey.toString());
				capEnrollValue.append(enrollMent + " " + capacity);
		...
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			try {
				...
				for (Text val : values) {
					...
					value = value.trim();
					String[] capEnrollValues = value.split(" ");
