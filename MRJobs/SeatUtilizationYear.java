...
public class SeatUtilizationYear {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass((Class) SeatUtilizationYear.class);
		...
		Job job2 = new Job(conf2, "seat utilization in different years");
		job2.setJarByClass((Class) SeatUtilizationYear.class);
