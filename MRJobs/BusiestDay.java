...
public class BusiestDay {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "busiest day in each semester");
		job.setJarByClass((Class) BusiestDay.class);
		...
		Job job2 = new Job(conf2, "busiest day in last few years");
		job2.setJarByClass((Class) BusiestDay.class);
	...
	public static class Mapper1 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws InterruptedException, IOException {
			...
			StringBuilder busiestDayKey = new StringBuilder();
			...
			try {
				...
				busiestDayKey.append(season + " " + year + " " + hallName + " " + day + " "
						+ courseId + " " + courseName);
				word.set(busiestDayKey.toString());
	...
	public static class Mapper2 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			try {
				...
				StringBuilder busiestDayKey = new StringBuilder();
				busiestDayKey.append(year + " " + hallName + " " + day);
				word.set(busiestDayKey.toString());
				context.write(word, new IntWritable(1));
			} catch (NumberFormatException e) {
				return;
