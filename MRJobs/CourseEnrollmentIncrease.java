...
public class CourseEnrollmentIncrease {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass((Class) CourseEnrollmentIncrease.class);
		...
		Job job2 = new Job(conf2, "course enrollment in every year one key");
		job2.setJarByClass((Class) CourseEnrollmentIncrease.class);
		...
		Job job3 = new Job(conf3, "course enrollment increase in every year range");
		job3.setJarByClass((Class) CourseEnrollmentIncrease.class);
	...
	public static class Mapper2 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			try {
				...
				int enrollment = Integer.parseInt(prevKeyTerms[3]);
				...
				context.write(word, new IntWritable(enrollment));
			} catch (NumberFormatException e) {
				return;
			}
		}
	...
	public static class Mapper3 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			int enrollment = Integer.parseInt(input[1]);
			prevKey = prevKey.trim();
			String[] prevKeyTerms = prevKey.split("_");
			...
			courseYearKey1.append(
					Integer.toString(((Integer.parseInt(year)) - 1)) + "-" + year + "_" + courseId + "_" + courseName);
			courseYearKey2.append(
					year + "-" + Integer.toString(((Integer.parseInt(year)) + 1)) + "_" + courseId + "_" + courseName);
