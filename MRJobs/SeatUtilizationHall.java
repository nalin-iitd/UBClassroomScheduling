...
public class SeatUtilizationHall {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass((Class) SeatUtilizationHall.class);
		...
		Job job2 = new Job(conf2, "seat utilization wrt different halls in different years");
		job2.setJarByClass((Class) SeatUtilizationHall.class);
	...
	public static class Mapper1 extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws InterruptedException, IOException {
			...
			try {
				...
				semesterHallCourseIdNameKey.append(season + " " + year + " " + hallName + " " + capacity + " "
